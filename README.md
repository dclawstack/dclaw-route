...
[![Status](https://img.shields.io/badge/status-P4%20Planned-0EA5E9)](https://github.com/dclawstack/dclaw-route)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/route)

---

## Overview

DClaw Route is an AI-native logistics application. It follows the standard DClaw architecture:
...
DClaw Route uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-route.git
cd dclaw-route
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_route"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-route.git /opt/dclaw-route
cd /opt/dclaw-route
docker compose up -d
```

The app will be available at `https://route.dclawstack.io`.
...
helm upgrade --install dclaw-route . \
  --namespace dclaw-route \
  --create-namespace
```
...
- [Docs](https://docs.dclawstack.io/apps/route)
